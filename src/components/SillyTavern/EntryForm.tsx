    ...
    <div style={{ padding: 12 }}>
      ...
      <Row label="备注 (comment)">
        <input
          ...
          style={{ width: '100%', padding: 6, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
        />
      </Row>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
        <Row label="位置 (position)">
          <select
            ...
            style={{ padding: 6, width: 220, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
          >
            {POSITIONS.map((p) => (
          ...
          <>
            <Row label="深度 (depth)">
              <input
                ...
                style={{ padding: 6, width: 80, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
              />
            </Row>
            <Row label="角色 (role)">
              <select
                ...
                style={{ padding: 6, width: 120, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
              >
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, marginBottom: 12 }}>
        <label style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'var(--jjk-text-3)' }}>
          <input
            type="checkbox"
        ...
        {value.useProbability && (
          <input
            ...
            style={{ padding: 4, width: 70, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
            min={0}
            max={100}
          />
        )}
      ...
      <details style={{ borderTop: '1px solid rgba(170,0,0,0.2)', paddingTop: 12 }}>
        <summary style={{ cursor: 'pointer', fontSize: 13, color: 'var(--jjk-text-3)' }}>
          高级设置
        </summary>
        <div style={{ paddingTop: 12 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 12 }}>
            <label style={{ color: 'var(--jjk-text-3)' }}>
              <input
                type="checkbox"
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 12 }}>
            <Row label="sticky">
              <input
                ...
                style={{ padding: 6, width: 90, background: 'rgba(28,28,28,0.8)', border: '1px solid rgba(170,0,0,0.3)', color: 'var(--jjk-text)' }}
              />
            </Row>
            <Row label="cooldown">
              <input
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12, color: 'var(--jjk-text-3)' }}>
            <input
              type="checkbox"
          ...
          <fieldset style={{ marginBottom: 12, border: '1px solid rgba(170,0,0,0.25)', padding: 8 }}>
            <legend style={{ fontSize: 12, color: 'var(--jjk-text-3)' }}>字符卡匹配</legend>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
              {(
                ...
                <label key={k} style={{ fontSize: 12, color: 'var(--jjk-text-3)' }}>
                  <input
                    type="checkbox"
